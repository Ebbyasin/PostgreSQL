...
/*
|  alternatifi belirtir (iki alternatiften biri).
...
--Bu soruda tedarikciler ve urunler tablusunu yeniden olusturduk

update urunler
set urun_isim = (select firma_ismi from tedarikciler where irtibat_ismi='Adam Eve')--ayni tablo olmadigi icin 
--alt sorguyla bagliyoruz.(select firma_ismi from tedarikciler....)
