...
--bunu silemeyiz cunku parentta..once childi silmeliyiz
...
DROP table talebeler CASCADE;--Parent tabloyu kaldirmak istersek Drop table tablo_adi'ndan sonra CASCADE
--komutunu kullaniriz.

--Talebeler tablosundaki isim sutununa NOTT NULL kisitlamasi ekleyiniz ve veri tipini VARCHAR (30) olarak
--degistiriniz.
...
--Yazili notu 85'ten buyuk talebe bilgilerini getirin
...
Hem sinav1 hemde sinav2 alani,50'den buyuk olan kayyitlari listeler
...
--2.YOL
select * from personel WHERE id>='1003' and id<='1005';--usttekiyle ayni sonucu elde ettik.
...
-- Maasi sadece 7000,100000 olan personeli listele

select * from personel WHERE maas IN ('70000','100000');
--Ayni sutun kullaniyorum,o yuzden IN kullanirim
