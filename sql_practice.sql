...
select * from personel where maas!=21000; --maas<>21000 de ayni..
...
select * from personel where email not like '%@gmail.com'; -- %  ile arama yaptigimiz icin null gelmez.BUNU SOR!!!

-- 11) id'si 3,5,7 ve 9 olan personel bilgilerini listeleyiniz.
select * from personel where id in(3,5,7,9); -- ayni turde bilgiye sahip veriler isteniyorsa in() parantezi kullanlr.
...
select * from personel order by yas; --dogal siralama kucukten buyuge asc

-- 17) personel bilgilerini maaşa göre sıralayınız.
select * from personel order by maas;-- kucukten buyuge siraladi
