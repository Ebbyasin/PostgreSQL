-- ORDER BY--
-- ORDER BY cumlecigi bir SORGU deyimi icerisinde belli ibr SUTUN'a gore 
...
select * from kisiler ORDER BY adres asc; --ASCENDING (ASG)yazmasakta sirali verir
-- kisiler tablosunu adres'e gore terten siralayarak sorgulayiniz.
select * from kisiler ORDER BY adres desc;-- DESCENDING (DESC) terten siralama yapacagimiz zaman kullaniriz.

--Kisiler maasi buyukten kucuge siralayiniz.
